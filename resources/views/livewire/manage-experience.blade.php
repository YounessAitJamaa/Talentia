<div class="p-6 bg-white border-b border-gray-200 mt-6">
    <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-medium text-gray-900">Expérience Professionnelle</h3>
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-4">
                            <label for="position" class="block text-gray-700 text-sm font-bold mb-2">Poste:</label>
    ...
    <div class="mt-4 space-y-4">
        @foreach($experiences as $experience)
            <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                <div>
                    <h4 class="font-bold text-lg">{{ $experience->position }} <span class="text-gray-500">chez</span>
                        {{ $experience->company }}</h4>
                    <p class="text-sm text-gray-500">
                        {{ $experience->start_date->format('M Y') }} -
                        {{ $experience->end_date ? $experience->end_date->format('M Y') : 'Présent' }}
                    </p>
                ...
                <div class="flex space-x-2">
                    ...
                    <button wire:click="delete({{ $experience->id }})" class="text-red-500 hover:text-red-700"
