<div class="bg-white p-2">
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        <div>
            ...
            <select wire:model="contract_type" class="mt-1 block w-full border-gray-300 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="p-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
            ...
            <div class="flex items-center gap-4">
                ...
                @if ($image)
                    <div class="relative">
                        <img src="{{ $image->temporaryUrl() }}" class="w-16 h-16 rounded-lg object-cover border-2 border-white shadow-sm">
